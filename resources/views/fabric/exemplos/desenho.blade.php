...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('dist/css/master.css') }}">
    <link rel="stylesheet" href="{{ asset('dist/css/prism.css') }}">
    <style>
        pre { margin-left: 15px !important }
    </style>
    <!--[if lt IE 9]>
    <script src="{{ asset('dist/js/excanvas.js') }}"></script>
    <![endif]-->
...
<body>
<h1>Novo</h1>
<canvas id="cd" width="600" height="500"></canvas>
...
<div id="bd-wrapper" ng-controller="CanvasControls">
    ...
    <!--[if IE]><script src={{ asset('dist/js/Delicious.font.js') }}></script><![endif]-->

    <script src={{ asset('dist/js/todos.js') }}></script>

    <link rel="stylesheet" href={{ asset('dist/css/todos.css') }}>
    ...
    <script src="{{ asset('dist/js/font_definitions.js') }}"></script>
    ...
    <script src="{{ asset('dist/js/app_config.js') }}"></script>
