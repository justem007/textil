...
namespace Illuminate\Support\Facades {
    ...
    class Artisan {
        ...
        public static function handle($input, $output = null)
        {
            ...
            return \Textil\Console\Kernel::handle($input, $output);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \Textil\Console\Kernel::terminate($input, $status);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \Textil\Console\Kernel::command($signature, $callback);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \Textil\Console\Kernel::registerCommand($command);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \Textil\Console\Kernel::call($command, $parameters, $outputBuffer);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \Textil\Console\Kernel::all();
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \Textil\Console\Kernel::output();
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \Textil\Console\Kernel::bootstrap();
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \Textil\Console\Kernel::setArtisan($artisan);
        }
...
namespace Cagartner\CorreiosConsulta {
    ...
    class Facade {
        ...
        {
            return \Cagartner\CorreiosConsulta\CorreiosConsulta::cep($cep);
        }
        ...
        {
            return \Cagartner\CorreiosConsulta\CorreiosConsulta::rastrear($codigo);
        }
...
namespace laravel\pagseguro\Platform\Laravel5 {
    ...
    class PagSeguro {
        ...
        {
            return \laravel\pagseguro\Facades\PagSeguro::checkout();
        }
        
        /**
         * 
         *
         * @return \laravel\pagseguro\Facades\Credentials 
         * @static 
         */
        public static function credentials()
        {
            return \laravel\pagseguro\Facades\PagSeguro::credentials();
        }
        
        /**
         * 
         *
         * @return \laravel\pagseguro\Facades\Item 
         * @static 
         */
        public static function item()
        {
            return \laravel\pagseguro\Facades\PagSeguro::item();
        }
        
        /**
         * 
         *
         * @return \laravel\pagseguro\Facades\Transaction 
         * @static 
         */
        public static function transaction()
        {
            return \laravel\pagseguro\Facades\PagSeguro::transaction();
        }
...
namespace Spatie\GoogleSearch\Facades {
    ...
    class GoogleSearch {
         ...
         * @static 
         */
        public static function getPageMapProperty($item, $type, $attribute)
        {
            return \Spatie\GoogleSearch\GoogleSearch::getPageMapProperty($item, $type, $attribute);
        }
...
namespace FetchLeo\LaravelXml\Facades {
    ...
    class Xml {
         ...
         * @static 
         */
        public static function convert($value, $element = null)
        {
            return \FetchLeo\LaravelXml\Xml::convert($value, $element);
        }
         ...
         * @static 
         */
        public static function getConverterFor($value, $debug = false)
        {
            return \FetchLeo\LaravelXml\Xml::getConverterFor($value, $debug);
        }
        ...
        {
            return \FetchLeo\LaravelXml\Xml::getType($value);
        }
...
namespace {
    ...
    class PagSeguro extends \laravel\pagseguro\Platform\Laravel5\PagSeguro {}
