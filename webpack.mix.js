...
mix.copy('resources/assets/js/fabrica/pinit.js', 'public/js/pinit.js');
...
mix.copy('resources/assets/js/locaweb/example.js', 'public/js/dist/examplo.js');
mix.copy('resources/assets/js/locaweb/locastyle.js', 'public/js/dist/locastyle.js');
mix.copy('resources/assets/js/locaweb/highcharts.js', 'public/js/dist/highcharts.js');
mix.copy('resources/assets/js/locaweb/panel-charts.js', 'public/js/dist/panel-charts.js');
mix.copy('resources/assets/js/locaweb/app.js', 'public/js/dist/app.js');
//fim
