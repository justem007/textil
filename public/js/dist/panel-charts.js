...
$(function () {
    ...
    $(document).on("sidebar-minimize sidebar-maximize", function () {
    ...
    }), $("#panel-charts-2").highcharts((_$$highcharts = {
        chart: {
            type: "line"
        },
        title: {
        ...
        }] }, _defineProperty(_$$highcharts, "legend", {
        lineHeight: 20
    }), _defineProperty(_$$highcharts, "tooltip", {
        crosshairs: !0, useHTML: !0
    }), _$$highcharts)), $("#panel-chart-pie-errors").highcharts({
        chart: {
    ...
    for (var e = [], t = 0; 125 >= t; t++) {
        switch (t) {
            case 0:
                e.push("Sem \xedndice");
                break;
            case 25:
                e.push("0 a 24 P\xe9ssima");
                break;
            case 50:
                e.push("25 a 49 Ruim");
                break;
            case 75:
                e.push("50 a 74 Regular");
                break;
            case 100:
                e.push("75 a 87 Boa");
                break;
            case 112:
                e.push("Acima de 87 \xd3tima");
                break;
            case 125:
                e.push("100 Nota m\xe1xima");
                break;
            default:
                e.push("");
        }
        ...
        colors: ["#303030"], series: [{
            ...
            crosshairs: !0, useHTML: !0, formatter: function formatter() {
